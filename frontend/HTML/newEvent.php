...
<head>
  ...
  <title>MyOrganized - Planner</title>
      ...
      <div class="rightColumn">
        ...
        <div class="block newEvent-dayAgenda">
          ...
          <div class="newEvent-dayAgenda-header">
            <div class="metaTag">La tua Giornata</div>
            <div class="elementSubtitle">Venerdì 19 Novembre</div>
          </div>
                    ...
                    <div class="newEvent-formFields ">
                        ...
                        <div class="newEvent-timeRow ">
                            ...
                            <div class="timeBlock ">
                                ...
                                <input type="time"  name="startTime" class="newEvent-inputTime ">
                            </div>
                            <div class="timeBlock ">
                                <span class="timeLabel ">Alle Ore:</span>
                                <input type="time" name="endTime" class="newEvent-inputTime ">
                            </div>
                            <!--
                        ...
                        <textarea name="descriz" class="newEvent-input newEvent-textarea " rows="3 " placeholder="Note "></textarea>
