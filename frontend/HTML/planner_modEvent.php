...
?>
<!-- ATTENZIONE: PAGINA COPIATA DA planner_newEvent.php -->
...
<head>
  ...
  <title>MyOrganized – Modifica Evento</title>
  ...
  <nav class="navbar-newEvent">
    <div class="navbar-newEvent-L">
      ...
      <div class="navbar-newEvent-titleBlock">
        <div class="main">Modifica Evento</div>
      ...
      <div class="newEvent-right">
        ...
        <!-- TODO: RENDERE DINAMICO -->
          ...
          <div class="newEvent-formIntro">
            <div class="newEvent-formIntro-small">Modifica un Evento</div>
          ...
          <form action="modEvent.php" method="post">
            <div class="newEvent-formFields">
              ...
              <div class="newEvent-fieldGroup">
                ...
                <input type="text" name="nameEvent" class="newEvent-input " value="<?php echo $row["title"] ?>">
              </div>
              ...
              <div class="newEvent-fieldGroup">
                ...
                <div class="newEvent-timeRow">
                  ...
                  <div class="timeBlock">
                    ...
                    <input type="time" name="endTime" class="newEvent-inputTime" value="<?php echo $endTime ?>">
                  </div>
              ...
              <div class="newEvent-fieldGroup">
                ...
                <textarea name="descriz" class="newEvent-input newEvent-textarea" rows="4" placeholder="Note"><?php echo $row["descriz"] ?></textarea>
              </div>
